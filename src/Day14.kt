...
fun main() {
    ...
    fun getRequiredOre(ingredient: Ingredient): Long {
        ...
        val recipeCreatesAmount = recipe.result.amount // The recipe creates this much of the ingredient for one execution
        ...
        val recipeTotalAmount = recipeCreatesAmount * executeRecipeTimes // The total amount of an ingredient we'll get
